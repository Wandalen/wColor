...
function _strToRgba( test )
{
  ...
  test.case = 'Red';
  var src = 'hwb(0%,100%,100%,0%,100%)';
  var expected = [ 1, 0, 0, 1 ];
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'Green';
  var src = 'hwb(100%,0%,100%,0%,100%)';
  var expected = [ 0, 1, 0, 1 ];
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'Blue';
  var src = 'hwb(100%,100%,0%,0%,100%)';
  var expected = [ 0, 0, 1, 1 ];
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'Yellow';
  var src = 'hwb(0%,0%,100%,0%,100%)';
  var expected = [ 1, 1, 0, 1 ];
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'Cyan';
  var src = 'hwb(100%,0%,0%,0%,100%)';
  var expected = [ 0, 1, 1, 1 ];
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'Magenta';
  var src = 'hwb(0%,100%,0%,0%,100%)';
  ...
  var src = 'hwb(111%,16%,75%,4%,5%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'second arg > 100%';
  var src = 'hwb(11%,160%,75%,4%,5%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'third arg > 100%';
  var src = 'hwb(11%,16%,750%,4%,5%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'fourth arg > 100%';
  var src = 'hwb(11%,16%,75%,400%,5%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );

  test.case = 'fifth arg > 100%';
  var src = 'hwb(11%,16%,75%,40%,500%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( null, src );
  test.identical( got, expected );
...
function _strToRgbaWithDst( test )
{
  ...
  var dst = [ 1, 2, 3, 4 ];
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color.hwb._strToRgba( dst, src );
  test.identical( got, expected );
  test.true( got === dst );
  ...
  test.case = 'hwb(12%,34%,99%,27%,31%), dst = Array';
  var src = 'hwb(12%,34%,99%,27%,31%)';
  var dst = [ 1, 2, 3, 4 ];
  ...
  test.case = 'hwb(12%,34%,99%,27%,31%), dst = Long';
  var src = 'hwb(12%,34%,99%,27%,31%)';
  ...
  test.case = 'hwb(12%,34%,99%,27%,31%), dst = TypedArray';
  var src = 'hwb(12%,34%,99%,27%,31%)';
  ...
  test.case = 'hwb(12%,34%,99%,27%,31%), dst = VectorAdapter';
  var src = 'hwb(12%,34%,99%,27%,31%)';
  var dst = _.vad.fromLong([ 1, 2, 3, 4 ]);
  var expected = [ 0.6431372549019608, 0.4823529411764706, 0.00784313725490196, 0.31 ];
  var got = _.color.hwb._strToRgba( dst, src );
  ...
  test.case = 'hwb(12%,34%,99%,27%) no alpha info, dst = Array';
  var src = 'hwb(12%,34%,99%,27%)';
  var dst = [ 1, 2, 3, 4 ];
  ...
  test.case = 'hwb(12%,34%,99%,27%) no alpha info, dst = VectorAdapter';
  var src = 'hwb(12%,34%,99%,27%)';
  var dst = _.vad.fromLong([ 1, 2, 3, 4 ]);
  var expected = [ 0.6431372549019608, 0.4823529411764706, 0.00784313725490196, 1 ];
  var got = _.color.hwb._strToRgba( dst, src );
  ...
  test.case = 'first arg > 100%';
  var src = 'hwb(111%,16%,75%,4%,31%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( [ 1, 2, 3, 4 ], src );
  test.identical( got, expected );

  test.case = 'second arg > 100%';
  var src = 'hwb(11%,160%,75%,4%,31%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( [ 1, 2, 3 ], src );
  test.identical( got, expected );

  test.case = 'third arg > 100%';
  var src = 'hwb(11%,16%,750%,4%,31%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( [ 1, 2, 3 ], src );
  test.identical( got, expected );

  test.case = 'fourth arg > 100%';
  var src = 'hwb(11%,16%,75%,400%,31%)';
  var expected = null;
  var got = _.color.hwb._strToRgba( [ 1, 2, 3 ], src );
  test.identical( got, expected );
  ...
  var src = 'hwb(12%,34%,99%,27%,31%)';
  var dst = [ 1, 2, 3, 5, 6 ];
  test.shouldThrowErrorSync( () => _.color.hwb._strToRgba( dst, src ) )
...
function _longToRgba( test )
{
  ...
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color.hwb._longToRgba( null, src );
  test.identical( got, expected );
...
function _longToRgbaWithDst( test )
{
  ...
  var dst = [ 1, 2, 3, 4 ];
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color.hwb._longToRgba( dst, src );
  test.identical( got, expected );
  test.true( got === dst );
  ...
  var src = [ 111, 16, 75, 4, 5 ];
  var expected = null;
  var got = _.color.hwb._longToRgba( [ 1, 2, 3, 4 ], src );
  test.identical( got, expected );

  test.case = 'second arg > 100%';
  var src = [ 11, 160, 75, 4, 5 ];
  var expected = null;
  var got = _.color.hwb._longToRgba( [ 1, 2, 3 ], src );
  test.identical( got, expected );
  ...
  var src = [ 12, 34, 99, 27, 31 ];
  var dst = [ 1, 2, 3, 5, 6 ];
  test.shouldThrowErrorSync( () => _.color.hwb._longToRgba( dst, src ) )
