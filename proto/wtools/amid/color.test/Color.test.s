...
function _cmykStrToRgb( test )
{
  ...
  var expected = [ 0, 0, 0 ];
  var got = _.color._cmykStrToRgb( null, src );
  test.identical( got, expected );
...
function _cmykStrToRgba( test )
{
  ...
  var got = _.color._cmykStrToRgba( null, src );
  test.identical( got, expected );
...
function _cmykStrToRgbWithDst( test )
{
  ...
  var dst = [ 1, 2, 3 ];
  var expected = [ 0, 0, 0 ];
  var got = _.color._cmykStrToRgb( dst, src );
  test.identical( got, expected );
  test.true( got === dst );
...
function _cmykStrToRgbaWithDst( test )
{
  ...
  var dst = [ 1, 2, 3, 4 ];
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._cmykStrToRgba( dst, src );
  test.identical( got, expected );
  test.true( got === dst );
  ...
  var src = 'cmyk(111%,16%,75%,4%)';
  var expected = null;
  var got = _.color._cmykStrToRgba( [ 1, 2, 3 ], src );
  test.identical( got, expected );
  ...
  var src = 'cmyk(12%,34%,99%,27%)';
  var dst = [ 1, 2, 3, 5, 6 ];
  test.shouldThrowErrorSync( () => _.color._cmykStrToRgba( dst, src ) )
...
_cmykStrToRgbaWithDst.accuracy = 1e-2;

//

function _hwbStrToRgb( test )
{
  ...
  var src = 'hwb(0, 0%, 100%)';
  var expected = [ 0, 0, 0 ];
  var got = _.color._hwbStrToRgb( null, src );
  test.identical( got, expected );
...
_hwbStrToRgb.accuracy = 1e-2;

//

function _hwbStrToRgba( test )
{
  ...
  var src = 'hwb(0, 0%, 100%)';
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._hwbStrToRgba( null, src );
  test.identical( got, expected );
...
_hwbStrToRgba.accuracy = 1e-2;

//

function _hwbStrToRgbWithDst( test )
{
  ...
  var dst = [ 1, 2, 3 ];
  var expected = [ 0, 0, 0 ];
  var got = _.color._hwbStrToRgb( dst, src );
  test.identical( got, expected );
  test.true( got === dst );
  ...
  var src = 'hwb(366,16%,75%)';
  var expected = null;
  var got = _.color._hwbStrToRgb( [ 1, 2, 3 ], src );
  test.identical( got, expected );
  ...
  var src = 'cmyk(12%,34%,99%,27%)';
  var dst = [ 1, 2, 3, 5, 6 ];
  test.shouldThrowErrorSync( () => _.color._hwbStrToRgb( dst, src ) )
...
_hwbStrToRgbWithDst.accuracy = 1e-2;


//

function _hwbStrToRgbaWithDst( test )
{
  ...
  var dst = [ 1, 2, 3, 4 ];
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._hwbStrToRgba( dst, src );
  test.identical( got, expected );
  test.true( got === dst );
  ...
  var src = 'hwb(366,16%,75%)';
  var expected = null;
  var got = _.color._hwbStrToRgba( [ 1, 2, 3, 4 ], src );
  test.identical( got, expected );
  ...
  var src = 'cmyk(12%,34%,99%,27%)';
  var dst = [ 1, 2, 3, 5, 6 ];
  test.shouldThrowErrorSync( () => _.color._hwbStrToRgba( dst, src ) )
...
_hwbStrToRgbaWithDst.accuracy = 1e-2;

//

function _hexStrToRgb( test )
{
  ...
  var src = '#000000';
  var expected = [ 0, 0, 0 ];
  var got = _.color._hexStrToRgb( src );
  test.identical( got, expected );
...
_hexStrToRgb.accuracy = 1e-2;

//

function _hexStrToRgba( test )
{
  ...
  var src = '#000000ff';
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._hexStrToRgba( src );
  test.equivalent( got, expected );
...
_hexStrToRgba.accuracy = 1e-2;

//

function _rgbStrToRgb( test )
{
  ...
  var src = 'rgb(0, 0, 0)';
  var expected = [ 0, 0, 0 ];
  var got = _.color._rgbStrToRgb( src );
  test.identical( got, expected );
...
_rgbStrToRgb.accuracy = 1e-2;

//

function _rgbaStrToRgba( test )
{
  ...
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._rgbaStrToRgba( src );
  test.equivalent( got, expected );
...
_rgbaStrToRgba.accuracy = 1e-2;

//

function _hslStrToRgb( test )
{
...
_hslStrToRgb.accuracy = 1.1e-2;

//


function _hslaStrToRgba( test )
{
...
_hslaStrToRgba.accuracy = 1.1e-2;

//

function _xyzStrToRgb( test )
{
...
function _xyzStrToRgba( test )
{
  ...
  var src = 'xyz(0.0000, 0.0000, 0.0000)';
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._xyzStrToRgba( src );
  test.identical( got, expected );
...
function _labStrToRgb( test )
{
  ...
  var expected = [ 0, 0, 0 ];
  var got = _.color._labStrToRgb( src );
  test.identical( got, expected );
...
function _labStrToRgba( test )
{
  ...
  var src = 'lab(0.00, 0.00, 0.00)';
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._labStrToRgba( src );
  test.identical( got, expected );
...
function _lchStrToRgb( test )
{
  ...
  var expected = [ 0, 0, 0 ];
  var got = _.color._lchStrToRgb( src );
  test.identical( got, expected );
...
function _lchStrToRgba( test )
{
  ...
  var src = 'lch(0, 0.000, 0.000)';
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._lchStrToRgba( src );
  test.identical( got, expected );
...
function _luvStrToRgb( test )
{
  ...
  var src = 'luv(0, 0, 0)';
  var expected = [ 0, 0, 0 ];
  var got = _.color._luvStrToRgb( src );
  test.identical( got, expected );
...
function _luvStrToRgba( test )
{
  ...
  var src = 'luv(0, 0, 0)';
  var expected = [ 0, 0, 0, 1 ];
  var got = _.color._luvStrToRgba( src );
  test.identical( got, expected );
...
let Self =
{
  ...
  tests :
  {
    ...
    _cmykStrToRgbaWithDst,

    _hwbStrToRgb,
    _hwbStrToRgba,
    _hwbStrToRgbWithDst,
    _hwbStrToRgbaWithDst,
